...
namespace solver
{
	class RealVariable //is method decleration a common thing in hpp files?
	{
	...
	{
	private:
		complex<double> a; //what does this mean?
		complex<double> b; //what does this mean?
		complex<double> c; //what does this mean?
	...
	double solve(bool ex); //what does this mean?
